"""Validate mkdocs_python_classy logging works."""
import mock
import mkdocs_python_classy
...
def test_initialize_logging_default(get_logger, basic_cfg):
    ...
    mkdocs_python_classy.log.initialize_logging()
    ...
    assert get_logger.mock_calls[0].args == ("mkdocs_python_classy",)
...
def test_initialize_logging_user_defined_config(get_logger, basic_cfg):
    ...
    mkdocs_python_classy.log.initialize_logging(config=config)
...
def test_initialize_logging_filename(get_logger, basic_cfg):
    ...
    mkdocs_python_classy.log.initialize_logging(filename="output.log")
